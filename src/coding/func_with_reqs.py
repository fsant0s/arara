...
def _to_code(
    func: Union[FunctionWithRequirements[T, P], Callable[P, T], FunctionWithRequirementsStr]
) -> str:
...
class FunctionWithRequirementsStr:
    ...
    def __init__(
        self, func: str, python_packages: List[str] = [], global_imports: List[Import] = []
    ):
        self.func = func
...
def _build_python_functions_file(
    funcs: List[
        Union[FunctionWithRequirements[Any, P], Callable[..., Any], FunctionWithRequirementsStr]
    ]
) -> str:
