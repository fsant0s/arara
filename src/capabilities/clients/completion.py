...
class Completion(openai_Completion):
    ...
    def _update_invalid_n(cls, prune, region_key, max_tokens, num_completions):
        if prune:
            ...
            cls._min_invalid_n_per_max_tokens[region_key] = invalid_n = (
                cls._min_invalid_n_per_max_tokens.get(region_key, {})
            )
        ...
        while True:  # n <= config_n
            ...
            while True:  # data_limit <= data_length
                ...
                if (
                    ...
                    # update valid n
                    cls._max_valid_n_per_max_tokens[region_key] = valid_n = (
                        cls._max_valid_n_per_max_tokens.get(region_key, {})
                    )
