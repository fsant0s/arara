"""
Enhanced logger for the ARARA framework with consistent formatting and contextual information.
...
class ContextualLogger:
    ...
    request IDs, operation IDs, agent information, and performance metrics.
    """
