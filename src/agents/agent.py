...
class Agent(BaseAgent):
    ...
    def __init__(
        ...
        Args:
            ...
            description (Optional[str], optional):
                Textual description of the Agent's purpose or behavior.

            chat_messages (Optional[Dict[BaseAgent, List[Dict]]], optional):
                Dictionary storing chat history between this Agent and others.
            ...
            tools (Optional[List[FunctionTool | Callable[..., Any] | Callable[..., Awaitable[Any]]]], optional):
                A list of external tools or functions the Agent can call.
    ...
    def talk_to(
        ...
        **kwargs,
        ...
        Args:
            recipient (Agent): The Agent to chat with.
    ...
    def send(
        ...
        Args:
            ...
            recipient (BaseAgent): The recipient Agent.
    ...
    def receive(
        ...
        Args:
            ...
            sender (BaseAgent): The sender Agent.
            request_reply (Optional[bool], optional):
    ...
    def generate_reply(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            sender (Optional[BaseAgent], optional):
                The sender Agent. Defaults to None.
            **kwargs: Additional arguments.
    ...
    def _generate_oai_reply(
        ...
        """Generate a reply using Agent.clients."""
    ...
    def register_reply(
        ...
        *,
        ...
        if not isinstance(trigger, (type, str, BaseAgent, Callable, list)):
            raise ValueError("trigger must be a class, a string, a Agent, a callable or a list.")
    ...
    def _reflection_with_llm_as_summary(self, sender, recipient, summary_args):
        ...
        prompt = Agent.DEFAULT_SUMMARY_PROMPT if prompt is None else prompt
    ...
    def check_termination_and_human_reply(
        ...
        Args:
            ...
            - sender (Optional[BaseAgent]): The agent object representing the sender of the message.
