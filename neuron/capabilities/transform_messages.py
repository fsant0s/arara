...
class TransformMessages:
    ...
    a Agent's incoming messages before they are processed for response
    ...
    3. Add the `TransformMessages` instance to your `Agent` using `add_to_agent`.
    ...
    def add_to_agent(self, agent: Agent):
        """Adds the message transformations capability to the specified Agent.
