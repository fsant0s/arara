...
def print_received_message(message: Union[Dict, str], sender: BaseAgent, name: str, llm_config : Union[Dict, Literal[False]]) -> None:
    ...
    if message.get("tool_responses"):  # Handle tool multi-call responses
        for tool_response in message["tool_responses"]:
            print_received_message(tool_response, sender)
