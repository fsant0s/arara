...
def process_message_before_send(
        self: BaseAgent, message: Union[Dict, str], recipient: BaseAgent, silent: bool
    ) -> Union[Dict, str]:
...
def process_last_received_message(self: BaseAgent, messages: List[Dict]) -> List[Dict]:
    """
...
def process_all_messages_before_reply(self: BaseAgent, messages: List[Dict]) -> List[Dict]:
    """
