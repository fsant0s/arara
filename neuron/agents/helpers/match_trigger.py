...
def match_trigger(self: BaseAgent, trigger: Union[None, str, type, BaseAgent, Callable, List], sender: Optional[BaseAgent]) -> bool:
    """Check if the sender matches the trigger.

    Args:
        - trigger (Union[None, str, type, BaseAgent, Callable, List]): The condition to match against the sender.
        Can be `None`, string, type, `BaseAgent` instance, callable, or a list of these.
        - sender (BaseAgent): The sender object or type to be matched against the trigger.
    ...
    elif isinstance(trigger, BaseAgent):
